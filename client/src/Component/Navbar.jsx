...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (final === "/skill-boost") final = "/skill-gap";
      ...
      >
        {isUser &&
          NavItemUser.map((item, index) => (
            <li
              key={index}
              className={`px-2 py-2 md:py-3 cursor-pointer hover:border-b-2 hover:   border-y-zinc-950 hover:font-medium ${
                activeNav === item.name
                  ? "border-b-2 border-y-zinc-950 font-medium"
                  : ""
              }`}
