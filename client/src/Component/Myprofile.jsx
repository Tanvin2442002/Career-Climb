...
const Myprofile = () => {
  ...
  return (
    <div className="myprofile-container flex flex-col font-sans bg-white">
      <Navbar />
      <div className="profile-content flex w-full p-5">
        <div className="left-panel flex flex-col w-2/3 mr-5 gap-5">
          {/* Education Section */}
          <section className="education">
            ...
            <div className="education-item-container flex items-center p-4 mb-4 border border-gray-300 rounded-xl bg-gray-50 relative">
              <div className="education-item flex items-center gap-4">
                <img
                  src="/assets/zirabo_logo.png"
                  alt="Zirabo School Logo"
                  className="education-logo w-15 h-15 rounded-full object-cover"
                />
                <div className="education-details flex-1">
          ...
          <section className="experience mt-10">
            ...
            <div className="experience-item-container flex items-center p-4 mb-4 border border-gray-300 rounded-xl bg-gray-50 relative">
              <div className="experience-item flex items-center gap-4">
                <img
                  src="/assets/mist_computer_club_logo.png"
                  alt="MIST Computer Club Logo"
                  className="experience-logo w-15 h-15 rounded-full object-cover"
                />
        ...
        <div className="left-panel2 flex flex-col w-2/3 mr-5 gap-5">
          {/* SKILLS */}
          <section className="education">
            ...
            <div className="education-item-container flex items-center p-4 mb-4 border border-gray-300 rounded-xl bg-gray-50 relative">
              <div className="education-item flex items-center gap-4">
                <img
                  src={html}
                  alt="Savar College Logo"
                  className="education-logo w-12 h-12 rounded-full object-cover"
                />
                <div className="education-details flex-1">
                  <h3 className="font-semibold text-lg">Savar Cantonment Public School & College</h3>
                  <p>Higher Secondary School Certificate</p>
      ...
      {/* Right Panel */}
<div className="right-panel w-1/3 sticky top-2 p-5 bg-green-50 rounded-xl shadow-lg h-[85vh] box-border">
