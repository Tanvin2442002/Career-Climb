...
router.post("/save/roadmap", async (req, res) => {
    ...
    const result = user_id ?
        await sql`INSERT INTO roadmap (from_role, to_role, user_id, data) VALUES (${from}, ${to}, ${user_id}, ${roadmap})`
        :
        await sql`INSERT INTO roadmap (from_role, to_role, data) VALUES (${from}, ${to}, ${roadmap})`;
